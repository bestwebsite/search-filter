...
*/
	...
	add_action('admin_menu', 'Bestwebsite_menu_pages');
	
	function Bestwebsite_menu_pages()
	{
		// Add the top-level admin menu
		$page_title = 'Search &amp; Filter Settings';
		$menu_title = 'Search &amp; Filter';
		$capability = 'manage_options';
		$menu_slug = 'Bestwebsite-settings';
		$function = 'Bestwebsite_settings';
		$icon_url = Bestwebsite_PLUGIN_URL.'/admin/icon.png';
		...
		$submenu_title = 'Help';
		$submenu_slug = 'Bestwebsite-help';
		$submenu_function = 'Bestwebsite_help';
	...
	function Bestwebsite_settings()
	{
		...
		echo '<div class="of-caption">
				Search &amp; Filter is a simple search and filtering plugin for Wordpress brought to you by <a href="http://www.Bestwebsite.com" target="_blank">Designs &amp; Code</a>.<br /><br />
		...
		echo '<div class="of-caption">
				Advanced documentation and examples has now moved - find it on our <a href="http://docs.Bestwebsite.com/search-filter/" target="_blank">Search &amp; Filter Plugin Documentation</a>.<br /><br />
		...
		echo '<div class="of-caption">
				...
				<pre><code class="string">[Bestwebsite fields="search,category,post_tag"]</code></pre>
				...
				<pre><code class="php">&lt;?php echo do_shortcode( \'[Bestwebsite fields="search,category,post_tag"]\' ); ?&gt;</code></pre>
			</div>';
		
		
		echo "<h3>Arguments</h3>";
		echo '<div class="of-caption">Examples for most of the arguments below can be found over on the <a href="http://docs.Bestwebsite.com/search-filter/#examples" target="_blank">Search &amp; Filter Plugin Documentation</a>.</div>';
		//display table
		...
		echo "<h3>Styling</h3>";
		echo '<div class="of-caption">
				Search &amp; Filter uses standard inputs and selects, form elements are contained in an unordered list - styling should be easy.  <a href="'.Bestwebsite_PLUGIN_URL . '/style.css'.'" target="_blank">Please see CSS file for base styles used.</a>
			</div>';
		...
		echo '<div class="of-caption">
				<ul>
					<li><a href="http://www.Bestwebsite.com/447/wordpress-search-filter-plugin-for-taxonomies/" target="_blank">Plugin Support Page &amp; Discussion</a></li>
					<li><a href="http://docs.Bestwebsite.com/search-filter/" target="_blank">Plugin Documentation</a></li>
...
*/
	...
	add_filter('plugin_action_links_'.Bestwebsite_BASENAME, 'Bestwebsite_plugin_action_links', 10, 2);

	function Bestwebsite_plugin_action_links($links, $file)
	{
		static $this_plugin;

		if (!$this_plugin)
		{
			$this_plugin = Bestwebsite_BASENAME;
		}
		...
		if ($file == $this_plugin)
		{
			...
			$settings_link = '<a href="' . get_admin_url() . 'admin.php?page=Bestwebsite-settings">Settings</a>';
